...
public class DatadrivenTesting2 {
	...
	{
		FileInputStream f=new FileInputStream("E:\\August3Batch\\WebdriverProject\\src\\com\\qedge\\excelfile\\registration.xlsx");
		...
		FileOutputStream f1=new FileOutputStream("E:\\August3Batch\\WebdriverProject\\src\\com\\qedge\\resultexcelfiles\\registration.xlsx");
		wb.write(f1);
		f1.close();
		driver.quit();
	}
