...
public class LinksTestingonGrid {
	@Parameters("browser")
	@Test
	public void linkTest(String b) throws IOException
	{
		...
		FileInputStream f=new FileInputStream("E:\\August3Batch\\WebdriverProject\\src\\com\\qedge\\excelfile\\links.xlsx");
		...
		FileOutputStream f1=new FileOutputStream("E:\\August3Batch\\WebdriverProject\\src\\com\\qedge\\resultexcelfiles\\"+b+"_links.xlsx");
		wb.write(f1);
		f1.close();
	}
